...
<main class="grid">
  ...
  <?php if ( is_search() ) {?>
    ...
    <h1>
      <?php esc_html_e( 'Risultato per: ', 'basetheme');?><?php echo $s;?>
    </h1>
    ...
    <form method="get" action="<?php echo esc_url(home_url());?>" class="form-search">
      <input type="text" placeholder="<?php esc_attr_e('Cerca...', 'basetheme');?>"name="s">
      <button type="submit">
    ...
    <?php else :?>
    <div clas="col-100"><?php esc_html_e('Non è stato trovato nessun articolo corrisondente alla tua ricerca, prova a cercare altro', 'basetheme');?></div>
    <?php endif;?>
